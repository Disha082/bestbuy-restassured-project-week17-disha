...
public class StoresExtractionTest {
    ...
    public void test001() {
        ...
        System.out.println("The Extract limit is : " + limit);
    ...
    public void test004() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The Extract name of all store is : " + storeName);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test005() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The Extract name of all store is : " + allStoreID);
        System.out.println("------------------End of Test---------------------------");
    }
